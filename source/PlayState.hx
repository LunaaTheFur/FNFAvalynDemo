	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'heavenly-prison':
				dialogue = CoolUtil.coolTextFile(Paths.txt('heavenly-prison/heavenly-prisonDialogue'));
			case 'restraint':
				dialogue = CoolUtil.coolTextFile(Paths.txt('restraint/restraintDialogue'));
			case 'ruined':
				dialogue = CoolUtil.coolTextFile(Paths.txt('ruined/ruinedDialogue'));
		}
